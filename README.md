...
Getting Started
Clone or Download this project as a single HTML file.
Open it in your web browser. No installation or dependencies needed.
File Structure
...
External Libraries: Loads jsPDF for PDF export.
How It Works
